...
const keyring = caver.wallet.keyring.createFromPrivateKey('0xdd53f73be047006dc5ff12364286d475515ac5510a71f02d1b4a3e0b63da12b0')
...
const contractInstance = caver.contract.create(json, '0xe317D1AC3cE3207c13208Bec6B603D27E403bE35')
  ...
  let klaytnObject= await contractInstance.methods.safeMint(addrssofmint,urlofimage)
  console.log(keyring.address)
  const klaytnReceipt = await klaytnObject.send({
    from:keyring.address,
    gas: await klaytnObject.estimateGas(),
  })
  console.log(klaytnReceipt)
  


  
  return klaytnReceipt
